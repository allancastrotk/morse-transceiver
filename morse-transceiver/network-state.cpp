// File: network-state.cpp
// Description: Link state manager implementation — TX / RX / FREE handling
// Non-blocking, lightweight; coordinates with telecom and connect modules via callbacks
// Modified: 2025-11-15
