// File: network-state.h
// Description: Link state manager for Morse project — manages TX / RX / FREE states
// Exposes API for local requests (down/up/symbol) and callbacks for remote events.
// Created: 2025-11-15
#ifndef NETWORK_STATE_H
#define NETWORK_STATE_H

#include <Arduino.h>
#include "cw-transceiver.h" // defines ConnectionState, timing constants
